...
# This version is intended to use in a powershell profile
...
function AdminExplorer([STRING] $Directory)
{
	...
	{	
		Start-ElevatedPowerShell "-sta ","-exit","Select-FileDialog -Directory '$Directory' -Title 'AdminExplorer' | Out-Null" 
	}
}
