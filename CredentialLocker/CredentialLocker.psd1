#
# Module manifest for module 'CredentialLocker'
#
# Generated by: Markus Scholtes
#
# Generated on: 2019-09-10
#

@{

# Script module or binary module file associated with this manifest.
RootModule = 'CredentialLocker.psm1'
...
GUID = 'ff25bfed-b11c-4781-9ded-bee5870696d6'
...
It can handle stored credentials of IE and Edge and it is a secure password safe for your application.
...
PrivateData = @{
	...
	PSData = @{
		...
		Tags = @('Windows', 'Credential', 'CredentialLocker', 'PasswordVault', 'Password', 'Vault')

		# A URL to the license for this module.
		LicenseUri = 'https://github.com/MScholtes/CredentialLocker/blob/master/LICENSE'

		# A URL to the main website for this project.
		ProjectUri = 'https://github.com/MScholtes/CredentialLocker'
